...
class OfferRuItemTimelineController extends Controller
{

    public function actionGetByOfferRuItemId()
    {
        $offer_ru_item_id = App::call()->request->getParams()['offer_ru_item_id'];
        $array = App::call()->offerRuItemTimelineRepository->getWhere([
    ...
    public function actionSave()
    {
        if (isset(App::call()->request->getParams()['id'])) {
            ...
            $item = App::call()->offerRuItemTimelineRepository->getObject($id);
        } else {
            $item = New OfferRuItemTimeline();
        }
        ...
        $result = App::call()->offerRuItemTimelineRepository->save($item);
    ...
    {
        $id = App::call()->request->getParams()['id'];
        $offerRuItemTimeline = App::call()->offerRuItemTimelineRepository->getObject($id);
        $result = App::call()->offerRuItemTimelineRepository->delete($offerRuItemTimeline);
