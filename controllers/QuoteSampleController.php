...
class QuoteSampleController extends Controller
{
    ...
    public function actionSave()
    {
        if (isset(App::call()->request->getParams()['id'])) {
            ...
            $quote_sample = App::call()->quoteSampleRepository->getObject($id);
        } else {
        ...
        $result = App::call()->quoteSampleRepository->save($quote_sample);
    ...
    public function actionDelete()
    {
        $id = App::call()->request->getParams()['id'];
        $quote_sample = App::call()->quoteSampleRepository->getObject($id);
        $result = App::call()->quoteSampleRepository->delete($quote_sample);
        echo json_encode(['result' => $result]);
    }
