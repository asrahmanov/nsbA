...
class Po extends Model
{
    ...
    )
    {
        ...
        $this->arrayParams['po_number'] = false;
        ...
        $this->arrayParams['po_status'] = false;
        $this->arrayParams['lab'] = false;
        $this->arrayParams['email_send'] = false;
        $this->arrayParams['po_text'] = false;
